<section class="space">
    <div class="container">
            ...
            <div class="col-xl-4 col-md-6">
                <div class="product-style2">
                    ...
                    <div class="product-content">
                        ...
                        <div class="actions">
                            <a href="#" class="simple-icon"><i class="far fa-heart"></i></a>
                            <a href="#" class="th-btn">order now</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="product-style2">
                    ...
                    <div class="product-content">
                        ...
                        <span class="product-meta"><i class="far fa-clock"></i>20 min away</span>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="product-style2">
                    ...
                    <div class="product-content">
                        ...
                        <span class="product-meta"><i class="far fa-clock"></i>10 min away</span>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="product-style2">
                    ...
                    <div class="product-content">
                        ...
                        <span class="product-meta"><i class="far fa-clock"></i>35 min away</span>
        ...
        <div class="text-center mt-5">
            <a href="#" class="th-btn">View All Menus</a>
        </div>
    </div>
